...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-background">
      {/* Left Panel - Branding & Features (hidden on mobile) - fixed colors for visibility in both themes */}
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 overflow-hidden">
